...
AppsCode projects are [Apache 2.0 licensed](https://github.com/stash-client/java/blob/master/LICENSE) and accept contributions via
...
contribution. See the [DCO](https://github.com/stash-client/java/blob/master/DCO) file for details.
...
If you have found a bug with Stash or want to request for new features, please [file an issue](https://github.com/stash-client/java/issues/new).
